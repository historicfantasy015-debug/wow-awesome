/*
  ...
  1. New Tables
    ...
    - `topics` - Stores topics under chapters with weightage and notes
...
-- Create policies for anon role access
CREATE POLICY "Allow anon read access on exams"
  ON exams FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Allow anon insert on exams"
  ON exams FOR INSERT
  TO anon
  WITH CHECK (true);

CREATE POLICY "Allow anon read access on courses"
...
CREATE POLICY "Allow anon read access on subjects"
  ON subjects FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Allow anon insert on subjects"
  ON subjects FOR INSERT
  TO anon
  WITH CHECK (true);

CREATE POLICY "Allow anon read access on units"
  ON units FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Allow anon insert on units"
  ON units FOR INSERT
  TO anon
  WITH CHECK (true);

CREATE POLICY "Allow anon read access on chapters"
  ON chapters FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Allow anon insert on chapters"
  ON chapters FOR INSERT
  TO anon
  WITH CHECK (true);

CREATE POLICY "Allow anon read access on topics"
  ON topics FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Allow anon insert on topics"
  ON topics FOR INSERT
  TO anon
  WITH CHECK (true);

CREATE POLICY "Allow anon update on topics"
  ON topics FOR UPDATE
  TO anon
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Allow anon read access on parts"
  ON parts FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Allow anon insert on parts"
  ON parts FOR INSERT
  TO anon
  WITH CHECK (true);

CREATE POLICY "Allow anon read access on slots"
  ON slots FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Allow anon insert on slots"
  ON slots FOR INSERT
  TO anon
  WITH CHECK (true);

CREATE POLICY "Allow anon read access on questions_topic_wise"
  ON questions_topic_wise FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Allow anon insert on questions_topic_wise"
  ON questions_topic_wise FOR INSERT
  TO anon
  WITH CHECK (true);

CREATE POLICY "Allow anon update on questions_topic_wise"
  ON questions_topic_wise FOR UPDATE
  TO anon
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Allow anon read access on new_questions"
  ON new_questions FOR SELECT
  TO anon
  USING (true);

CREATE POLICY "Allow anon insert on new_questions"
